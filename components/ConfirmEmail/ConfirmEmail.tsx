...
export default function ConfirmEmail({isEmailConfirmed, email}: Props) {
  ...
  return (
    <div className={styles.wrapper}>
      Ваша электронная почта {email} не подтверждена, поэтому смена почты и некоторые другие функции
      для Вас недоступны. Нажмите кнопку ниже, чтобы отправить письмо с подтверждением на почту.
      {isStartConfirm ? (
